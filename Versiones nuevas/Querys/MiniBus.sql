...
create table pasajero(
	...
	dni 						int primary key,
	id_tipo_abono 				int not null references tipo_abono(id_tipo_abono)
);
...
create table recorrido(
    ...
    patente						varchar(20) references minibus(patente),
...
create table salida(
    ...
    kilometros_odometro_actual  int,
...
create table paradas(
	...
	id_interseccion_calle_1		int  references calle(id_calle),
    id_interseccion_calle_2 	int  references calle(id_calle),
	id_localidad 				int  references localidad(id_localidad)
);
